...
col1.st.plotly_chart(fig_qnt_estado, use_container_width=True)

df_qnt_mun = df['NM_MUNIC'].value_counts()[:10].reset_index(name="total")
...
col2.st.plotly_chart(fig_qnt_mun, use_container_width=True)
